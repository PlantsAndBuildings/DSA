...
/**
 * \brief \ref sorting::InsertionSorter_t::sort() "sort()" function
 * specialization for `float` data type
 *
 * Calls private method \ref sorting::InsertionSorter_t::sortUtilNumeric
 * "sortUtilNumeric()"
 *
 * \param list vector of `float`s to be sorted
 */
template <> void sorting::InsertionSorter_t<float>::sort(vector<float> &list) {
  if (list.empty())
    return;
 ...
 */
template <>
void sorting::InsertionSorter_t<double>::sort(vector<double> &list) {
  if (list.empty())
    return;
 ...
 */
template <> void sorting::InsertionSorter_t<int>::sort(vector<int> &list) {
  if (list.empty())
    return;
 ...
 */
template <> void sorting::InsertionSorter_t<long>::sort(vector<long> &list) {
  if (list.empty())
    return;
 ...
 */
template <>
void sorting::InsertionSorter_t<long long>::sort(vector<long long> &list) {
  if (list.empty())
    return;
